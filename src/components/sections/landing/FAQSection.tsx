        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-12">
          ...
          <div>
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-brand-blue-900">FAQ</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-balance text-brand-blue-900">
          ...
          <div>
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className={`text-xl font-medium transition-colors ${openIndex === index ? 'text-brand-orange-500' : 'text-brand-blue-900 group-hover:text-brand-blue-900'}`}>
                    {faq.question}
                  </span>
                ...
                >
                  <p className="text-lg text-brand-blue-900/60 leading-relaxed max-w-[540px]">
                    {faq.answer}
                  </p>
                </div>
              </div>
