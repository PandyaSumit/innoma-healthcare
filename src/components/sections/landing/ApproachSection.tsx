    ...
    <section className="py-12 sm:py-16 md:py-24 bg-white overflow-hidden" id="approach">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-14 md:mb-20 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-brand-blue tracking-tight leading-tight max-w-3xl mx-auto">
            Comprehensive Trauma-Informed{" "}
            <span className="text-brand-orange">Clinical Excellence</span>
          </h2>
                ...
                >
                  <span
                    className={`uppercase tracking-widest text-[10px] font-bold transition-colors ${
                      item.featured ? "text-brand-orange group-hover/btn:text-white" : "text-brand-blue group-hover/btn:text-brand-orange"
                    }`}
                  >
                    Learn More
                  </span>
                  <svg
                    className={`w-5 h-5 transition-transform group-hover/btn:translate-x-1 ${
                      item.featured ? "text-white" : "text-brand-blue"
                    }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
