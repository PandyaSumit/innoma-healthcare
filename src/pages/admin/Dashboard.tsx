          ...
          <>
            <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              <AdminStatCard
                ...
                value={data?.cards?.totalTherapists ?? 0}
                to="/admin/therapists"
              ...
              <AdminStatCard
                ...
                value={(data?.cards?.totalSessions ?? 0).toLocaleString()}
              ...
              <AdminStatCard
                label="Total Revenue"
                value={`$${(data?.cards?.totalRevenue ?? 0).toLocaleString()}`}
                to="/admin/finance"
              ...
              <AdminStatCard
                ...
                value={data?.cards?.newUsersMonth}
              ...
              <AdminStatCard
                ...
                value={data?.cards?.sessionsMonth}
              ...
              <AdminStatCard
                ...
                value={data?.cards?.pendingArticles}
                to="/admin/articles"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 relative z-10">
                {[
                  ...
                  },
                  {
                    ...
                    color:
                      "bg-orange-50 text-brand-orange border-orange-100/50",
                  },
