...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      {!dashboardData?.hasUsedFreeAssessment && (
        <section className="bg-brand-blue/10 border border-brand-blue/20 rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
          <div className="flex items-center gap-4 text-center sm:text-left">
            ...
            <div>
              <h2 className="text-lg font-bold text-healthcare-text">Claim your first free session!</h2>
              <p className="text-sm text-healthcare-text-muted">Get a complimentary 50-minute assessment to start your journey.</p>
            </div>
          </div>
          <Link
            to="/find-therapist"
            className="px-6 py-2.5 bg-brand-blue text-white rounded-lg text-sm font-bold no-underline hover:opacity-90 shadow-md whitespace-nowrap"
          >
            Claim Assessment
          </Link>
        </section>
