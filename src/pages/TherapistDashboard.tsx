          ...
          },
          {
            ...
            note:
              todaySessions.length > 0
                ? `Next at ${formatTime(todaySessions[0]?.time)}`
                : "No sessions today",
        ...
        {allUpcoming.length > 0 ? (
          ...
          <div className="text-center py-8">
            <div className="w-14 h-14 bg-healthcare-surface rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
                className="w-7 h-7 text-healthcare-text-muted"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <h3 className="text-lg font-bold text-healthcare-text mb-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="w-10 h-10 bg-healthcare-surface rounded-lg flex items-center justify-center mb-4">
            <svg
              className="w-5 h-5 text-healthcare-text-muted"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-healthcare-text-muted mb-4">
              Each booked session includes a unique meeting link. You can join
              sessions 15 minutes before the scheduled time. Meeting links are
              automatically generated when patients complete their booking.
            </p>
