...
const Confirmation = () => {
  ...
  const {
    ...
    time,
    appointmentId,
    meetingLink: passedMeetingLink,
    invoiceNumber: passedInvoice,
    total,
    isFreeAssessment,
  } = location.state || {};
  ...
  const meetingLink = passedMeetingLink ?? null;
  const invoiceNumber = passedInvoice ?? (appointmentId ? `INN-${appointmentId.slice(0, 8).toUpperCase()}` : `INN-${Date.now()}`);
    ...
    <div>
      <div className="max-w-4xl mx-auto py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-healthcare-text mb-3">
          ...
          <div className="bg-gradient-to-r from-brand-blue to-healthcare-lavender p-8 text-white">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <p className="text-sm opacity-90 mb-1">{isFreeAssessment ? 'Session Type' : 'Total Paid'}</p>
                {isFreeAssessment ? (
          ...
          <div className="p-8">
            <div className="flex gap-6 mb-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-healthcare-text-muted mb-3">
                  {therapist.qualifications || therapist.specializations?.[0] || therapist.specialization || ''}
                </p>
                {therapist.rating && (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-healthcare-text">
                      {isFreeAssessment ? 'Free Assessment' : pkg?.name}
                    </p>
                    {isFreeAssessment && (
                      <span className="inline-block mt-1 px-2 py-0.5 bg-green-100 text-green-700 text-xs font-bold rounded">FREE</span>
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1">
                  ...
                  {meetingLink ? (
                    ...
                    <p className="text-sm text-green-700">
                      Your meeting link will be sent to your registered email address once the session is confirmed by the therapist. You can also find it in your appointments dashboard.
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="bg-healthcare-lavender/20 rounded-lg border border-healthcare-lavender/30 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-healthcare-text">Confirmation email sent to your registered email address</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-healthcare-text">WhatsApp reminder will be sent 24 hours before your session</p>
                </div>
                <div className="flex items-start gap-3">
