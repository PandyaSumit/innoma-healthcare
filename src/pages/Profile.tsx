        ...
        <form onSubmit={formik.handleSubmit} className="h-full">
          ...
          {isTherapist && activeTab === "professional" && (
            <div className="space-y-12 animate-slide-up min-h-[400px]">
              <section className="space-y-6">
                <h3 className="text-base font-bold text-healthcare-text">
          ...
          {activeTab === "security" && (
            <div className="space-y-10 animate-slide-up min-h-[400px]">
              <div className="p-6 bg-brand-blue/5 border border-brand-blue/10 rounded-[12px] flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-healthcare-text mb-1">
                    Secure Account
                  </h4>
                  <p className="text-xs text-healthcare-text-muted">
                    Maintain a robust password to ensure your records remain
              ...
              <section className="space-y-6 pt-6 border-t border-healthcare-border">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-[10px] bg-healthcare-surface/30 border border-healthcare-border">
                    <div>
                      <h5 className="text-sm font-bold text-healthcare-text">
                        Email Notifications
                      </h5>
                      <p className="text-xs text-healthcare-text-muted">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={() =>
                          formik.setFieldValue(
                            "notificationEmail",
                            !formik.values.notificationEmail,
                          )
                        }
                      />
                  ...
                  <div className="flex items-center justify-between p-4 rounded-[10px] bg-healthcare-surface/30 border border-healthcare-border">
                    <div>
                      ...
                      <p className="text-xs text-healthcare-text-muted">
                        Stay updated on the go with real-time mobile
                        notifications.
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
          ...
          {activeTab === "display" && (
            <div className="space-y-8 animate-slide-up min-h-[400px]">
              <InfoField
                label={isTherapist ? "Professional Bio" : "Bio / About Me"}
                isEditable
              >
                <textarea
                  name="bio"
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (current.includes(tag)) {
                            ...
                            formik.setFieldValue("healthInterests", [
                              ...current,
                              tag,
                            ]);
                          }
          ...
          {isTherapist && activeTab === "availability" && (
            <div className="space-y-8 animate-slide-up min-h-[400px]">
              <div className="p-6 bg-brand-blue/5 border border-brand-blue/10 rounded-2xl">
                ...
                <p className="text-xs text-healthcare-text-muted mb-6">
                  Select your available time slots for each day. Patients can
            ...
            <div className="space-y-8 animate-slide-up min-h-[400px]">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="text-3xl font-bold text-healthcare-text">
                    4.8
                  </div>
                  <div>
                ...
                {[
                  {
                    ...
                    date: "2 days ago",
                    comment:
                      "Dr. Anjali is incredibly patient and understanding. Her approach helped me manage my anxiety much better.",
                  },
                  {
                    name: "Priya K.",
                    rating: 4,
                    date: "1 week ago",
                    comment:
                      "Very professional. The session was helpful, though I would have liked more time for the initial intake.",
                  },
                  {
                    name: "Anonymous",
                    rating: 5,
                    date: "2 weeks ago",
                    comment:
                      "LIFE CHANGING! Highly recommend to anyone struggling with trauma.",
                  },
                ].map((review, idx) => (
                  <div
                    key={idx}
                    className="p-6 rounded-2xl bg-healthcare-surface/30 border border-healthcare-border space-y-3"
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="text-sm font-bold text-healthcare-text">
                          {review.name}
                        </div>
                        <div className="text-[10px] text-healthcare-text-muted">
                          {review.date}
                        </div>
                      </div>
                      <div className="flex text-yellow-400">
                    ...
                    <p className="text-sm text-healthcare-text leading-relaxed italic">
                      "{review.comment}"
                    </p>
                  </div>
                ))}
...
const InfoField = ({ label, children, isEditable }: any) => (
  <div className="space-y-1.5 group">
    <div className="flex items-center justify-between px-0.5">
      <label className="text-[11px] font-bold text-healthcare-text-muted uppercase tracking-wider">
        {label}
      </label>
      {isEditable && (
        <span className="text-[10px] font-bold text-brand-blue/0 group-hover:text-brand-blue transition-all uppercase tracking-tighter">
          Edit Field
        </span>
      )}
    </div>
