    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          <h2 className="text-xl sm:text-2xl font-bold text-healthcare-text mb-4">Invalid booking details</h2>
          <Link
            to="/find-therapist"
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-healthcare-text">Complete Payment</h1>
        <p className="text-sm text-healthcare-text-muted mt-1">Secure payment powered by Razorpay</p>
      </div>
      ...
      <div>
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center justify-center gap-2 sm:gap-4">
            ...
            <div className="h-px w-6 sm:w-16 bg-green-500" />
            <div className="flex items-center gap-1.5 sm:gap-2">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-green-500 text-white flex items-center justify-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
              ...
              <span className="hidden sm:inline text-sm font-semibold text-healthcare-text">Date & Time</span>
              <span className="sm:hidden text-xs font-semibold text-healthcare-text">Schedule</span>
            </div>
            <div className="h-px w-6 sm:w-16 bg-brand-blue" />
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-xs sm:text-sm font-semibold text-healthcare-text">Payment</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-healthcare-border p-4 sm:p-6">
              <h2 className="text-lg sm:text-xl font-semibold text-healthcare-text mb-4 sm:mb-6">Select Payment Method</h2>
            ...
            {paymentMethod === 'card' && (
              <div className="bg-white rounded-xl border border-healthcare-border p-4 sm:p-6">
                <h3 className="text-base sm:text-lg font-semibold text-healthcare-text mb-4">Card Details</h3>
            ...
            {paymentMethod === 'upi' && (
              <div className="bg-white rounded-xl border border-healthcare-border p-4 sm:p-6">
                <h3 className="text-base sm:text-lg font-semibold text-healthcare-text mb-4">UPI ID</h3>
                <input
                  type="text"
          ...
          <div>
            <div className="bg-white rounded-xl border border-healthcare-border p-4 sm:p-6 sticky top-8">
              <h3 className="text-lg sm:text-xl font-semibold text-healthcare-text mb-4 sm:mb-6">Order Summary</h3>
